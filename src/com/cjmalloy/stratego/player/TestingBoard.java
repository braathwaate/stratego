...
*/
	...
	public boolean nonRepeatableMove(int m)
	{
		...
		// addPlanValue() can change hash, so call isRepeated()
		// before addPlanValue()
	...
	protected void genFleeRankandWeak()
	{
		...
		// Opponent pieces (including known bombs)
		// in the foray area are a juicier target
